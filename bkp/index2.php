...
<div class="container-12">
    <header>
        ...
        <div id="menu">
            <ul>
                <a href="<?= SITEURL ?>">
                    <li class="active one">Home</li>
                </a>
                <a href="<?= SITEURL ?>empresa">
                    <li class="">Empresa</li>
                </a>
                ...
                <a href="<?= SITEURL ?>catalogo">
                    <li class="">Catalogo</li>
                </a>
                <a href="<?= SITEURL ?>distribuidores">
                    <li class="">Distribuidores</li>
                </a>
                <a href="<?= SITEURL ?>contato">
                    <li class=" six">Contato</li>
                </a>
            </ul>
        </div>
    ...
    <section>
        ...
        <!-- grid-16 -->
        <meta charset="utf-8"/>
        <div class="grid-16" style="width:100%;" id="tudo">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-12">
                        <div class="social">
                            ...
                            <a href="https://www.facebook.com/pronutrydistribuidora/?ref=br_rs" target="_blank"><i
                                        class="fa fa-facebook"></i></a>
                            <a href="https://www.instagram.com/pronutry_distribuidora/" target="_blank"><i
                                        class="fa fa-instagram"></i></a>
                            <a href="https://api.whatsapp.com/send?phone=5518998068039&text=sua%20mensagem"
            ...
            <div class="col-lg-12 col-sm-12">
                <div class="row">
                    <div class="titulo">
                        ...
                        <h1 class="viva" style="margin-top: 20px;">Viva de bem com a vida</h1>
                ...
                LIMIT 1";
                    ...
                    <div class="guia2" id="video">


                        <div class="owl-carousel owl-theme"
                             style="float: center!important; width: 100%!important; margin-top: -20px!important;">
                            <div class="item"
                                 style="float: center!important; width: 100%!important; border-radius: 10px!important;">
                                <iframe style=" border-radius: 10px!important;" type="text/html" width="100%"
                                        height="405"
                                        src="https://www.youtube.com/embed/AnCQbhWdd78?enablejsapi=1"
                                        frameborder="0" allowfullscreen></iframe>
                            </div>
                            <div class="item">
                                <iframe style=" border-radius: 10px!important;" type="text/html" width="100%"
                                        height="405"
                                        src="https://www.youtube.com/embed/usMTVCu6C50?enablejsapi=1"
                                        frameborder="0" allowfullscreen></iframe>
                            </div>
...
<footer>
    <div class="foo_inner">
        <div class="pag">
            ...
            <p>
                +55 (18) 3916-1113 ou pelo e-mail <a href="mailto:sac@pronutry.com.br"
                                                     target="_top">sac@pronutry.com.br</a><br/>
        ...
        <div class="fb">
            <h1>Facebook</h1>
            <div class="fb-like-box" data-href="https://www.facebook.com/pronutrydistribuidora/?ref=br_rs"
                 data-width="480" data-height="185" data-colorscheme="light" data-show-faces="true" data-header="false"
    ...
    <div class="whatsapp-chat">
        ...
        <a id="aLink" href="https://api.whatsapp.com/send?phone=5518998068039&text=Sua%20Mensagem&amp;" target="_blank"
           class="hide-web">
