        ...
        <div class="grid-16" style="width:100%;">
            ...
            <div id="catalogomobile">
                ...
                <section>
                    ...
                    <div style="width:100%;">
                        <div>
                        <a href="imgs/teste.pdf"/> <img width="100%" class="img-responsive" src="imgs/catalogo.jpg"/></a>
                        </div> <!-- features -->
                    </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        }).css({'display':'none', 'margin':'auto', 'width':'100%'}).fadeIn(1000);

                        $("#cover2").click(function(){
                            $.wowBook("#features2").advance();
                        });
                    });
                </script>
