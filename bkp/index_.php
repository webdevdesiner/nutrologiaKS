                ...
                <section id="main-slider" style="width:90%;">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" style="border-radius: 10px!important;">
                            ...
                            <div class="carousel-item active oneByOne_item" >
                                <img width="100%" src="http://www.pronutry.com.br//admin/uploads/slides/max-pecan.jpg" class="img-responsive">
                            </div>
                            <div class="carousel-item" >
                                <img width="100%" src="http://www.pronutry.com.br//admin/uploads/slides/digerin3.jpg" class="img-responsive">
                            </div>
                            <div class="carousel-item" >
                                <img width="100%" src="http://www.pronutry.com.br//admin/uploads/slides/catumax.jpg" class="bigImage">
                            </div>
                            <div class="carousel-item">
                                <img width="100%" src="http://www.pronutry.com.br//admin/uploads/slides/canela-de-velho.jpg" class="bigImage">
                            </div>
                            <div class="carousel-item">
                                <img width="100%" src="http://pronutry.com.br//admin/uploads/slides/oleo_pecan.jpg" class="bigImage">
                            </div>
                            <div class="carousel-item">
                                <img width="100%" src="http://pronutry.com.br//admin/uploads/slides/omega.jpg" class="bigImage">
                            </div>
    ...
    <div class="col-lg-12 col-sm-12">
        <div class="row">
            ...
            <div class="guia2" id="video" >
                ...
                <div class="owl-carousel owl-theme" style="float: center!important; width: 100%!important; margin-top: -20px!important;">
                    <div  class="item" style="float: center!important; width: 100%!important; border-radius: 10px!important;">
                        <iframe style=" border-radius: 10px!important;" type="text/html" width="100%" height="405"
