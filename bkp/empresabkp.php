...
<head>
    ...
    <script data-cfasync="false" type='text/javascript'>/*<![CDATA[*/window.olark||(function(c){var f=window,d=document,l=f.location.protocol=="https:"?"https:":"http:",z=c.name,r="load";var nt=function(){
        ...
        olark.identify('3259-366-10-3266');/*]]>*/</script><noscript><a href="https://www.olark.com<?=SITEURL?>/3259-366-10-3266/contact" title="Contact us" target="_blank">Questions? Feedback?</a> powered by <a href="http://www.olark.com?welcome" title="Olark live chat software">Olark live chat software</a></noscript>
    <!-- end olark code -->
...
<div class="container-12">
    ...
    <section>
        ...
        <div class="grid-16" style="width:100%;">
            ...
            <div class="sobre">
                <div class="imgsobre">
                    <img src="imgs/empresa1.jpg" alt="A Empresa" style="width:100%;">
                </div>
                <h1>Sobre Nossa Empresa</h1>
                <p>
                    Desde 2008, a PRONUTRY, vem desempenhando na sociedade, um trabalho voltado a terapia natural. Com métodos e produtos de qualidade, tendo marcas próprias, auxilia a saúde de muitas pessoas, conscientizando a todos com seus colaboradores, a utilização dos métodos de fonte natural.  </p>
                <p>    Conheça nossos produtos, Revenda-os e recomende! Atendemos em todos os setores de nosso segmento.  </p>
                <p>   Venha você também e alie-se a nós, nessa Missão. Na Pronutry, sua saúde é nossa prioridade!
                </p>
            </div>
            ...
            <a href="catalogo">
                <div class="catalogo">
                    <img src="imgs/catalogo2.jpg" alt="Catálogo">
            ...
            <div class="cadastro">
                ...
                <form action="distribuidores.php" method="post">
