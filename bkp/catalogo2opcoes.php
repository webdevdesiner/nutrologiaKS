                ...
                <section>
                    <nav class="controle">
                        <ul>
                            ...
                            <li><a id='back'      href="#" title='Voltar uma página'  >Back</a></li>
                            <li><a id='next'      href="#" title='Pular uma página'>Next</a></li>
                    ...
                    <div id="main" style="margin-bottom:40px;margin-top:60px; width:100%;">
                        <div id='features'>
                            <?php
                            $dir = "imgs/catalogo/";
                            for ($i=1;$i<=52;$i++){
